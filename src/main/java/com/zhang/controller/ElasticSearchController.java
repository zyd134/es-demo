...
import com.zhang.service.IndexService;
import com.zhang.service.IndexService2;
...
//    private static String host = "localhost";     //elasticsearch的服务器地址
    private static String host = "192.168.10.246";    //elasticsearch的服务器地址
    ...
    @RequestMapping("indexService2")
    public String indexService2() throws UnknownHostException {
        indexService2.createIndex();
        return "ok";
    }
    @RequestMapping("indexService")
    public String indexService() throws UnknownHostException {
